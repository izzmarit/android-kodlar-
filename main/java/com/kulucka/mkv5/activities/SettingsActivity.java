...
public class SettingsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private LinearLayout layoutOTAUpdate;
    ...
    private void initializeViews() {
        ...
        layoutOTAUpdate = findViewById(R.id.layoutOTAUpdate);
        layoutOTAUpdate.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.layoutOTAUpdate) {
            intent = new Intent(this, OTAUpdateActivity.class);
        }
