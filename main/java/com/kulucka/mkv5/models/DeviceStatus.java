...
public class DeviceStatus {
    ...
    private AlarmsInfo alarms;

    // Sensör bilgileri için sınıf
    public static class SensorsInfo {
        @SerializedName("sensor1")
        private SensorDetail sensor1;

        @SerializedName("sensor2")
        private SensorDetail sensor2;
        ...
        public static class SensorDetail {
            ...
            @SerializedName("tempCalibration")
            private float tempCalibration;

            @SerializedName("humidCalibration")
            private float humidCalibration;
            ...
            public float getTempCalibration() { return tempCalibration; }
            public void setTempCalibration(float tempCalibration) { this.tempCalibration = tempCalibration; }

            public float getHumidCalibration() { return humidCalibration; }
            public void setHumidCalibration(float humidCalibration) { this.humidCalibration = humidCalibration; }
        }

        public SensorDetail getSensor1() { return sensor1; }
        public void setSensor1(SensorDetail sensor1) { this.sensor1 = sensor1; }

        public SensorDetail getSensor2() { return sensor2; }
        public void setSensor2(SensorDetail sensor2) { this.sensor2 = sensor2; }
    }

    // Alarm bilgileri için sınıf
    public static class AlarmsInfo {
        ...
        @SerializedName("humidLow")
        private float humidLow;

        @SerializedName("humidHigh")
        private float humidHigh;

        public boolean isEnabled() { return enabled; }
        public void setEnabled(boolean enabled) { this.enabled = enabled; }

        public float getTempLow() { return tempLow; }
        public void setTempLow(float tempLow) { this.tempLow = tempLow; }

        public float getTempHigh() { return tempHigh; }
        public void setTempHigh(float tempHigh) { this.tempHigh = tempHigh; }

        public float getHumidLow() { return humidLow; }
        public void setHumidLow(float humidLow) { this.humidLow = humidLow; }

        public float getHumidHigh() { return humidHigh; }
        public void setHumidHigh(float humidHigh) { this.humidHigh = humidHigh; }
    }

    // Getter methods ekleyin
    public SensorsInfo getSensors() { return sensors; }
    public void setSensors(SensorsInfo sensors) { this.sensors = sensors; }

    public AlarmsInfo getAlarms() { return alarms; }
    public void setAlarms(AlarmsInfo alarms) { this.alarms = alarms; }
