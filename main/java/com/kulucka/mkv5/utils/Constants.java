...
public class Constants {
    ...
    public static final int WIFI_MODE_CHANGE_TIMEOUT = 40; // 25'ten 40'a çıkarıldı
    public static final int WIFI_CONNECT_TIMEOUT = 30; // 20'den 30'a çıkarıldı
    public static final int WIFI_SCAN_TIMEOUT = 25; // 20'den 25'e çıkarıldı
    public static final int SYSTEM_VERIFY_TIMEOUT = 15; // 10'dan 15'e çıkarıldı
    ...
    public static final int MODE_CHANGE_DELAY = 3000; // 1 saniyeden 3 saniyeye çıkarıldı
    public static final int IP_CHECK_DELAY = 3000; // 2 saniyeden 3 saniyeye çıkarıldı
    public static final int SYSTEM_STABILIZATION_DELAY = 5000; // 3 saniyeden 5 saniyeye çıkarıldı
    public static final int WIFI_MODE_CHANGE_DELAY = 3000; // 3 saniye
    ...
    public static final String KEY_WIFI_PASSWORDS_PREFIX = "wifi_passwords_";
    ...
    public static final long AUTO_CONNECT_INTERVAL = 5000; // 5 saniye
    public static final int MAX_AUTO_CONNECT_ATTEMPTS = 3;
    public static final long CONNECTION_RETRY_DELAY = 2000; // 2 saniye

    // Bağlantı durumu mesajları
    public static final String CONNECTION_STATUS_CONNECTED = "Bağlı";
    public static final String CONNECTION_STATUS_DISCONNECTED = "Bağlı Değil";
    public static final String CONNECTION_STATUS_CONNECTING = "Bağlanıyor...";
    public static final String CONNECTION_STATUS_ERROR = "Bağlantı Hatası";
}