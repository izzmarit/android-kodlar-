...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun saveSettings() {
        try {
            ...
            // Spinner'dan alınan hayvan türü
            ...
            Log.d("SettingsActivity", "Ayarlar gönderiliyor: $updatedSettings")

            // "Ayarlar gönderiliyor" mesajı göster
            Toast.makeText(this, "Ayarlar gönderiliyor...", Toast.LENGTH_SHORT).show()

            // ViewModel üzerinden ayarları güncelle - bu işlem ESP32'ye de gönderecek
            viewModel.updateSettings(updatedSettings)

            // Başarı mesajı ve ekranı kapat
