...
public class PidSettingsActivity extends AppCompatActivity {
    ...
    private void updateUI() {
        ...
        // Set parameters
        etKp.setText(String.format("%.2f", currentStatus.getPidKp()));
        etKi.setText(String.format("%.2f", currentStatus.getPidKi()));
        etKd.setText(String.format("%.2f", currentStatus.getPidKd()));
