...
public class SharedPrefsManager {
    ...
    private static final String KEY_PID_KP = "pid_kp";
    private static final String KEY_PID_KI = "pid_ki";
    private static final String KEY_PID_KD = "pid_kd";
    ...
    public String getDeviceIp() {
        return sharedPreferences.getString(KEY_DEVICE_IP, "192.168.1.100");
    }
    ...
    public void savePidSettings(PidSettings settings) {
        ...
        editor.putFloat(KEY_PID_KP, settings.getPidKp());
        editor.putFloat(KEY_PID_KI, settings.getPidKi());
        editor.putFloat(KEY_PID_KD, settings.getPidKd());
        editor.apply();
    }

    public PidSettings loadPidSettings() {
        PidSettings settings = new PidSettings();
        settings.setPidKp(sharedPreferences.getFloat(KEY_PID_KP, 2.0f));
        settings.setPidKi(sharedPreferences.getFloat(KEY_PID_KI, 5.0f));
        settings.setPidKd(sharedPreferences.getFloat(KEY_PID_KD, 1.0f));
        return settings;
    }
    ...
    public void resetToDefaults() {
        ...
        editor.putFloat(KEY_PID_KP, 2.0f);
        editor.putFloat(KEY_PID_KI, 5.0f);
        editor.putFloat(KEY_PID_KD, 1.0f);
    ...
    public String exportSettings() {
        try {
            ...
            jsonObject.put(KEY_PID_KP, pidSettings.getPidKp());
            jsonObject.put(KEY_PID_KI, pidSettings.getPidKi());
            jsonObject.put(KEY_PID_KD, pidSettings.getPidKd());
    ...
    public boolean importSettings(String jsonString) {
        try {
            ...
            if (jsonObject.has(KEY_PID_KP)) {
                editor.putFloat(KEY_PID_KP, (float) jsonObject.getDouble(KEY_PID_KP));
            }
            if (jsonObject.has(KEY_PID_KI)) {
                editor.putFloat(KEY_PID_KI, (float) jsonObject.getDouble(KEY_PID_KI));
            }
            if (jsonObject.has(KEY_PID_KD)) {
                editor.putFloat(KEY_PID_KD, (float) jsonObject.getDouble(KEY_PID_KD));
            }
