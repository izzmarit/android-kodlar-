...
public class PidSettingsFragment extends Fragment {
    ...
    private static final long REFRESH_INTERVAL = 3000; // 3 saniye
    ...
    private void savePidSettings() {
        ...
        try {
            ...
            // Genel ayarlar
            params.put("pidMode", switchPidEnabled.isChecked() ? 1 : 0);
            params.put("autoTuning", switchAutoTuning.isChecked());

            // Sıcaklık PID - sadece sıcaklık PID parametreleri
    ...
    private boolean validatePidInputs() {
        // Sıcaklık PID değerleri - sadece sıcaklık için kontrol
