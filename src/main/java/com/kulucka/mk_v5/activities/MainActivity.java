...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void setupBroadcastReceiver() {
        dataUpdateReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if ("com.kulucka.mk_v5.DATA_UPDATE".equals(action)) {
                ...
                } else if ("com.kulucka.mk_v5.IP_UPDATE".equals(action)) {
                    String newIP = intent.getStringExtra("new_ip");
                    if (newIP != null && !newIP.isEmpty()) {
                        updateIpAddress(newIP);
                        Log.d(TAG, "IP address updated from broadcast: " + newIP);
                    }
                }
            }
        };
    ...
    protected void onResume() {
        ...
        // Broadcast receiver'ı kaydet - hem veri güncellemeleri hem IP güncellemeleri için
        IntentFilter filter = new IntentFilter();
        filter.addAction("com.kulucka.mk_v5.DATA_UPDATE");
        filter.addAction("com.kulucka.mk_v5.IP_UPDATE");
