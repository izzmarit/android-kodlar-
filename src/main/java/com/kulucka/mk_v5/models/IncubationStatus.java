...
public class IncubationStatus {
    ...
    @SerializedName("pidModeActive")
    private boolean pidModeActive;
    ...
    public boolean isPidModeActive() {
        return pidModeActive;
    }

    public void setPidModeActive(boolean pidModeActive) {
        this.pidModeActive = pidModeActive;
    }
}